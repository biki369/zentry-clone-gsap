    ...
    <div className="min-h-screen w-screen" id="about">
      <div className="relative flex flex-col items-center gap-5 mb-8 mt-36">
        <h2 className="font-general text-sm uppercase md:text-[10px]">
          ...
          {/* Disc<b>o</b>ver the Worlds L<b>a</b>rgest shared adventure */}
          <AnimatedTitle title="Disc<b>o</b>ver the Worlds L<b>a</b>rgest shared adventure" containerClass={"mt-5 !text-black "}/>
